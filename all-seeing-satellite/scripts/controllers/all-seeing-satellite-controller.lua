...
function all_seeing_satellite_controller.do_tick(event)
    ...
    all_seeing_satellite_controller.planet_index, all_seeing_satellite_controller.planet = next(
    Constants.planets_dictionary, all_seeing_satellite_controller.planet_index)
