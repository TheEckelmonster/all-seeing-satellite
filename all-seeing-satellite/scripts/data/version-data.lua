...
function version_data:new(o)
    ...
    local defaults = {
        ...
        major = Major_Data:new({ value = version_data.major.value, }),
        minor = Minor_Data:new({ value = version_data.minor.value, }),
        bug_fix = Bug_Fix_Data:new({ value = version_data.bug_fix.value, }),
