...
function scan_chunk_service.stage_selected_chunk(chunk_to_chart, optionals)
  ...
  local i = chunk_to_chart[optionals.mode].i >= 0 and chunk_to_chart[optionals.mode].i <= radius and chunk_to_chart[optionals.mode].i or optionals.i
  local j = chunk_to_chart[optionals.mode].j >= 0 and chunk_to_chart[optionals.mode].j <= radius and chunk_to_chart[optionals.mode].j or optionals.j
